...
const Client = require("zeronetjs-protocol/lib/client")

const PeerRequest = require("peer-request")
const validate = require("zeronetjs-common/lib/verify").verifyProtocol
const PeerRequestHandler = require("zeronetjs-protocol/lib/request/peer-request-handler.js")

const Defaults = require("zeronetjs-protocol/lib/proto/defaults")
const Crypto = require("zeronetjs-crypto/protocol")
