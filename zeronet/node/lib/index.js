...
const Swarm = require("zeronetjs-swarm")
const UiServer = require("zeronetjs-uiserver/lib/index.js")
...
const PeerPool = require("zeronetjs-common/lib/peer/pool")
const TrackerManager = require("zeronetjs-common/lib/tracker/manager")
const ZiteManager = require("zeronetjs-zite/lib/manager")

const StorageWrapper = require("zeronetjs-common/lib/storage/wrapper") //wraps a storage into a more usable api
