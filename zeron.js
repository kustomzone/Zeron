...
let dwait = require("./zeronet/lib/hacky-logs.js")
...
const ZeroNet = require("zeronetjs-node")

const FS = require("zeronetjs-storage-fs")

const Common = require("zeronetjs-common")

let dir = require("./zeronet/lib/storage-dir")()
